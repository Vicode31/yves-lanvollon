...
export const metadata: Metadata = {
  ...
  keywords: [
    "hypnose lanvollon",
    "hypnotherapeute lanvollon",
    "hypnothérapeute lanvollon",
    "hypnotherapie lanvollon",
    "hypnothérapie lanvollon",
    "hypnose thérapeutique lanvollon",
    "cabinet d'hypnose lanvollon",
    "cabinet d'hypnothérapie lanvollon",
    "hypnose plouha",
    "hypnothérapeute côtes d'armor",
    "arrêt tabac hypnose lanvollon",
    "hypnothérapie",
    "hypnose",
    "yves deniau",
  ],
